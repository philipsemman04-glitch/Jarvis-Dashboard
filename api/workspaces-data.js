  ...
  try {
    ...
    const workspaces = wsPages.map((p) => {
      ...
      return {
        ...
        taskCounts: totalTasksByProject[name] !== undefined ? {
          total: totalTasksByProject[name],
          active: activeTasksByProject[name] || 0,
          inactive: totalTasksByProject[name] - (activeTasksByProject[name] || 0),
        } : null,
