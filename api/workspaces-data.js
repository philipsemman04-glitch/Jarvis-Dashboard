...
async function updateWorkspace(req, res) {
  const { workspaceId, name, icon, description, route, accentColor, status, statLabel, coverUrl } = req.body || {};
  ...
  try {
    ...
    const workspaces = wsPages.map((p) => {
      ...
      return {
        ...
        icon: getRichText(props, "Display Icon") || getRichText(props, "Icon") || "📁",
