...
module.exports = async (req, res) => {
  try {
    ...
    // Status and Priority are both `select` type in this database (confirmed).
    const actionPages = await queryDatabase(DB_ACTIONS, {
      filter: { property: "Project Rel", relation: { contains: PROJECT_ONG_ID } },
