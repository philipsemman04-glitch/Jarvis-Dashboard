...
module.exports = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({
      project: { key, canonicalName: projectName, label: displayName, icon, coverUrl: workspaceCoverFile || workspaceMatch?.properties["Cover URL"]?.url || workspaceMatch?.properties["Cover"]?.url || match.properties["Cover URL"]?.url || match.properties["Cover"]?.url || null },
      areas,
      board,
      tasks,
      stats: {
