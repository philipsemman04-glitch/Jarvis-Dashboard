...
(function () {
  ...
  function buildSidebarHTML(workspaces, appLogoUrl) {
    ...
    function itemHTML(w) {
      ...
      const href = canonical === "One Night Guest"
        ? `/ong-calendar.html?project=${encodeURIComponent(canonical)}`
  ...
  const FALLBACK = [
    ...
    { name: "One Night Guest", icon: "🏛️", route: "/ong-calendar.html?project=One%20Night%20Guest", type: "Business", status: "Live", order: 1 },
